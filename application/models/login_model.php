    ...
    */
    public function addUserItem(){
        ...
        if (empty($_POST['user_name'])) {
            ...
            $item_new_name = strip_tags($_POST['item_new_name']);
            ...
            if($count==0){
                ...
                $sql = "UPDATE items SET user_name=:user_name, item_name=:item_new_name, item_description=:item_description, item_DOB=:item_DOB,  item_lastTracked=:item_lastTracked, item_picture=:item_picture, item_isLost= :item_isLost, item_eLeashOn=:item_eLeashOn, item_eLeashRange=:item_eLeashRange, item_macAddress=:item_macAddress
    ...
    */
    public function addUserBeacon(){
        ...
        if (empty($_POST['user_name'])) {
            ...
            $item_new_name = $_POST['item_new_name'];
