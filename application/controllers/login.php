...
class Login extends Controller
{
    ...
    function login()
    {
        ...
        if ($login_successful) {
            ...
            //echo $_SESSION["feedback_positive"][0];
           ...
           /*$cookie = isset($_COOKIE['rememberme']) ? $_COOKIE['rememberme'] : '';
            ...
            echo json_encode($login_successful);
            //echo '{"success":1}';//,"cookie":"'.$_COOKIE['rememberme'].'"}';
        } else {
    ...
    */
    ...
    {
        // run the getUserItems() method in the login-model, put the result in $item_successful (true or false)
        $login_model = $this->loadModel('Login');
        // perform the getUserItems method, put result (true or false) into $item_successful
        $item_successful = $login_model->getUserItems();
    ...
    /***
    *   This function adds a new item to the list of existing user items
    */
    function addUserItem(){
        // run the addUserItem() method in the login-model, put the result in $item_successful (true or false)
        $login_model = $this->loadModel('Login');
        // perform the addUserItem method, put result (true or false) into $item_successful
        $item_successful = $login_model->addUserItem();
