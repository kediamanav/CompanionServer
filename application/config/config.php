...
define('IMAGE_PATH', 'public/itemImages/');
...
define("EMAIL_VERIFICATION_FROM_EMAIL", "admin@keeper.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Keeper");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Keeper");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your account: ");
...
//Define user item feedbacks
define("FEEDBACK_USER_NOT_LOGGEDIN", "Trying to access data without logging in");
define("FEEDBACK_USERDATA_NOT_RETRIVED", "The data could not be loaded from server");
define("FEEDBACK_ITEM_NAME_FIELD_EMPTY", "The item name field is empty");
define("FEEDBACK_ITEM_MAC_ADDRESS_FIELD_EMPTY", "The item does not have a MAC address");
